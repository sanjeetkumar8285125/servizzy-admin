...
router.post('/wheelService',authenticate,async(req,res)=>{
...
res.render('wheelService',{data:data,message:"No Service Available"})
    }catch(err){
...
router.post('/wheelService/edit',authenticate,async(req,res)=>{
try{
